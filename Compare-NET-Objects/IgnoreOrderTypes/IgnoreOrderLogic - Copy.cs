    ...
    public class IgnoreOrderLogic : BaseComparer
    {
            ...
            bool reverseCompare)
        {
            ...
            while (enumerator1.MoveNext())
            {
                ...
                matchingSpec = matchingSpec ?? GetMatchingSpec(parms.Result, enumerator1Type);
                ...
                while (enumerator2.MoveNext())
                {
                    ...
                    enumerator2Type = enumerator2Type ?? enumerator2.Current.GetType();
                    matchingSpec2 = matchingSpec2 ?? GetMatchingSpec(parms.Result, enumerator2Type);
